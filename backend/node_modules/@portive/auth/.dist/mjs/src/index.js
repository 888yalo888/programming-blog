 ...
 * e.g. PRTV_xxxxxxxxxxxxxxxx_xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
 */
export function stringifyApiKey({ keyId, secretKey, }) {
 ...
 */
export function _createAuthToken(claims, { keyId, secretKey, expiresIn, }) {
 ...
 */
export function createAuthToken(apiKey, { expiresIn, ...claims } // PermitPrivateClaims & { expiresIn: ExpiresIn }
) {
